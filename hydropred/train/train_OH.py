...
axes[1].scatter(test_outputs.detach().numpy(), test_energy_graph.detach().numpy(), label = 'Test')
axes[1].set_xlabel('Predicted')
axes[1].set_ylabel('Observed')
axes[1].set_title('Test: {}'.format(test_solute))
axes[1].legend(loc='upper left')

fig.savefig('../../img/ZS_train_{}_test_{}'.format(train_solute, test_solute))